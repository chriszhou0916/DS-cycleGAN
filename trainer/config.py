...
def get_config():
    ...
    parser.add_argument('--latent_z_dim',     default=8,  type=int, help='dimension of latent vector')
    ...
    parser.add_argument('--ds_loss', default=10, type=int, help='diversity sensitive regularizer loss weight')
    ...
    parser.add_argument('--ds_name', default='cycle_gan/horse2zebra', help='what kind of normalization to use')
